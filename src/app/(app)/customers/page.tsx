  ...
  return (
    <div className="space-y-6">
      <PageHeader
        eyebrow="الأطراف"
        title="العملاء"
        description="المصانع والموزّعون وتجار التجزئة — الذمم، أعمار الديون، وكشوف الحساب."
        actions={
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatTile label="ذمم قائمة" value={<Money value={d.totals.receivables} decimals={0} />} icon={Wallet} tone="meadow" />
