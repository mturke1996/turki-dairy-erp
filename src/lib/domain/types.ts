...
export interface Expense {
  ...
  /**
   * يربط مصروف الراتب بكشف الرواتب المولِّد له.
   * مصروف «انعكاسي»: الحركة النقدية والقيد المحاسبي يأتيان من كشف الرواتب نفسه،
   * فلا يُنشئ قيداً منفصلاً ولا يُحتسب ضمن المصاريف التشغيلية (تفادياً للازدواج).
   */
  sourcePayrollBatchId?: string;
  createdAt: string;
}
