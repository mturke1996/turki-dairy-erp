...
export function generateSeedV3(sessionId: string): SeedV3 {
  ...
  const employees: Employee[] = [
    { id: 'emp-1', code: 'E-001', fullName: 'صالح أبو بكر القذافي', jobTitle: 'مشرف التجميع', department: 'operations', salaryType: 'monthly', baseSalary: 2200, allowances: { housing: 300, transport: 250, food: 150 }, hireDate: '2023-02-01', contractType: 'permanent', defaultPayoutType: 'vault', defaultPayoutId: 'vault-main', phone: '0913001001', status: 'active', createdAt: D(1) },
    { id: 'emp-2', code: 'E-002', fullName: 'عبدالله مفتاح الشريف', jobTitle: 'سائق نقل', department: 'logistics', salaryType: 'daily', baseSalary: 85, allowances: { housing: 0, transport: 50, food: 30 }, hireDate: '2023-05-10', contractType: 'permanent', defaultPayoutType: 'vault', defaultPayoutId: 'vault-field', phone: '0913001002', status: 'active', createdAt: D(1) },
    { id: 'emp-3', code: 'E-003', fullName: 'مريم خالد الفيتوري', jobTitle: 'محاسبة', department: 'finance', salaryType: 'monthly', baseSalary: 2400, allowances: { housing: 350, transport: 200, food: 150 }, hireDate: '2022-09-15', contractType: 'permanent', bankId: 'bank-jumhouria', defaultPayoutType: 'bank', defaultPayoutId: 'bank-jumhouria', phone: '0913001003', status: 'active', createdAt: D(1) },
    { id: 'emp-4', code: 'E-004', fullName: 'يوسف عمر بالحاج', jobTitle: 'عامل تجميع', department: 'operations', salaryType: 'half_month', baseSalary: 1300, allowances: { housing: 150, transport: 150, food: 120 }, hireDate: '2024-01-20', contractType: 'permanent', defaultPayoutType: 'vault', defaultPayoutId: 'vault-main', phone: '0913001004', status: 'active', createdAt: D(1) },
    { id: 'emp-5', code: 'E-005', fullName: 'حسين علي الورفلي', jobTitle: 'سائق نقل', department: 'logistics', salaryType: 'daily', baseSalary: 80, allowances: { housing: 0, transport: 40, food: 25 }, hireDate: '2024-03-01', contractType: 'temporary', defaultPayoutType: 'vault', defaultPayoutId: 'vault-field', phone: '0913001005', status: 'active', createdAt: D(1) },
    { id: 'emp-6', code: 'E-006', fullName: 'فاطمة الصديق الزروق', jobTitle: 'موظفة إدارية', department: 'management', salaryType: 'half_month', baseSalary: 1800, allowances: { housing: 250, transport: 150, food: 120 }, hireDate: '2023-11-05', contractType: 'permanent', defaultPayoutType: 'vault', defaultPayoutId: 'vault-main', phone: '0913001006', status: 'on_leave', createdAt: D(1) },
  ];
