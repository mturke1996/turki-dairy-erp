...
import { Building2, Globe, Tractor, Users } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { DEBT_DIRECTION_LABELS, defaultDebtDirection } from '@/lib/domain/debt';
import type { DebtDirection, DebtEntry, DebtPartyKind } from '@/lib/domain/types';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md gap-0 p-0 sm:max-w-lg">
        <DialogHeader className="border-b border-border px-5 py-4">
          ...
          <DialogDescription>له = علينا · عليه = لنا — يُضاف للرصيد فوراً.</DialogDescription>
        </DialogHeader>
